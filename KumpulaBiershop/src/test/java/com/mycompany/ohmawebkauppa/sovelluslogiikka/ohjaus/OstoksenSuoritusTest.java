...
public class OstoksenSuoritusTest {
    Rahasto pankki = new PankkiFasaadi();
    PankkiFasaadi hylkaavaPankki = teeHylkaavaPankki();
    Logistiikka toimitusjarjestelma = new ToimitusjarjestelmaFasaadi();
    ...
    public void josMaksuOnnistuuKoriTyhjenee() {
        ostoksenSuoritus = new OstoksenSuoritus(nimi, osoite, luottokortti, kori, varasto, pankki, toimitusjarjestelma);
